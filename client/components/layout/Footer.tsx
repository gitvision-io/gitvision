...
function Footer() {
  return (
    <div className="bg-gray-100 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        <div className="md:max-w-md lg:col-span-2">
          ...
          <div className="mt-4 lg:max-w-sm">
            <p className="text-sm text-gray-800">{SITE_INFOS.subtitle}</p>
          </div>
        </div>
